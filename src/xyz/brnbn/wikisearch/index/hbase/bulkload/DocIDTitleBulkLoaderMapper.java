...
public class DocIDTitleBulkLoaderMapper 
    ...
    public void map(LongWritable key, Text value, Context context)
    	...
    	if (!value.toString().isEmpty()) {
			...
			KeyValue kv = new KeyValue(rowKey, CreateHBaseTables.COLFAMILY_TITLE.getBytes(), "TITLE".getBytes(), st.nextToken().getBytes());
