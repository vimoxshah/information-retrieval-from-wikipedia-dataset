...
public class TitleDocIDBulkLoaderMapper 
    ...
    public void map(LongWritable key, Text value, Context context)
    	...
    	if (!value.toString().isEmpty()) {
			...
			KeyValue kv = new KeyValue(rowKey, CreateHBaseTables.COLFAMILY_DOCID.getBytes(), "DOCID".getBytes(), st.nextToken().getBytes());
